...
const ADD_SUCCESS_OCR =
  "Receipt was successfully added, check back later to confirm receipt info!";
    ...
    return receipts.length > 0 ? (
      receipts.map((receipt) => (
        <div key={receipt.id}>
          <Divider light />
          <ReceiptRow
            toConfirm={ocrFeatureFlag ? isConfirmedReceipts : false}
            receipt={receipt}
